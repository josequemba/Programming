def main():
    try:
        ...
        phone_numbers = read_list("C:\\Users\\Jose Eliud Dias\\Desktop\Programming\\CSE 111 Programming with Functions\\phone_numbers.txt")
...
def add_area_code(phone_number):
    ...
    """
    if 12 != len(phone_number):
        number = "208-" + phone_number
    else:
        number = phone_number
    return number
