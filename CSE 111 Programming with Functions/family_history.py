...
def print_marriages(marriages_dict, people_dict):
    ...
    """
    print ('Marriages')
    for data in marriages_dict.items ():
        key = data [0]
        value = data [1]
        ...
        husbands_data = people_dict [husband_key]
        wives_data = people_dict [wife_key]
       
        #Getting the names
        husband_name = husbands_data [NAME_INDEX]
        wife_name = wives_data [NAME_INDEX]

        husband_age_wedding = wedding_year - husbands_data [BIRTH_YEAR_INDEX]
        wife_age_wedding = wedding_year - wives_data [BIRTH_YEAR_INDEX]
